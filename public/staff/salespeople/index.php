...
<div id="main-content">
  ...
  <?php
    ...
    while($salesperson = db_fetch_assoc($salespeople_result)) {
      ...
      echo "<td>";
      echo "<a href=\"show.php?id=" . u(filter_var($salesperson['id'], FILTER_SANITIZE_URL)) . "\">Show</a>";
      echo "</td>";
      echo "<td>";
      echo "<a href=\"edit.php?id=". u(filter_var($salesperson['id'], FILTER_SANITIZE_URL)) ."\">Edit</a>";
      echo "</td>";
      echo "</tr>";
